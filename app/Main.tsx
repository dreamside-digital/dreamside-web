    ...
    <>
      ...
      <SectionContainer id="packages" className="py-12 md:py-12">
        <div className="space-y-12 bg-white p-8 py-12 dark:bg-primary-500 md:p-16">
          ...
          <div>
            <p className="mb-4 text-xl">
              I offer two standard packages that cover the requirements of many typical projects.
              Both options give you a huge amount of flexibility in terms of design and
              functionality, and I can build additional features as needed. If you have even more
              specialized needs, I'd be happy to put together a proposal for you.
            </p>
            <p className="mb-4 text-xl">
