...
export default function Values() {
  return (
    <div>
      <div className="flex justify-end text-right md:text-left">
        <Parallax speed={-5} className="w-3/4 md:w-1/3 mt-24">
      ...
      <div className="flex justify-start">
        <Parallax speed={10} className="w-3/4 md:w-1/3 mt-24">
      ...
      <div className="flex justify-end md:justify-center text-right md:text-left">
        <Parallax speed={-2} className="w-3/4 md:w-1/3 mt-36">
