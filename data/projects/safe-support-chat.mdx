...
description: An embeddable, privacy-focused chatbox that connects to a secure messaging app called Matrix. Safe Support Chat is used by sexual assault support centres across Ontario."
