---
title: An honest review of Webflow's new localization feature
date: '2024-02-07'
lastmod: '2024-02-07'
tags:
  - technical
  - Webflow
summary: I got a chance to try out Webflow's new localization feature in a recent project, the Abortion Access Tracker. In short, it's convenient that it's built right into the Webflow interface, but it has some major gotchas. Even on a relatively small site, we ran into a lot of issues with things like string interpolation, localizing dates, images within components, and editing permissions. 
