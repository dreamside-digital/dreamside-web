---
title: 'Nomadic Labs is now Studio Shay!'
date: '2024-01-30'
lastmod: '2024-01-30'
tags: ['news', 'business', 'personal']
draft: false
summary: 'After a year of changes and reflection, Nomadic Labs is rebranding as Studio Shay!'
...
## Goodbye Nomadic Labs and hello Studio Shay
...
I also had a baby in 2022 so for a good portion of 2022 and part of 2023 I was on maternity leave. I now have two young daughters who bring so much joy and meaning to my life. Having a young family has really brought the future into focus for me, and gives new importance and urgency to continuing to work towards a world that is equitable, sustainable, and inclusive. 

This past year has been one of deep personal growth and reflection that has led to my decision to reboot Nomadic Labs as Studio Shay. I hope to bring much more of my full and authentic self to my work, which is why I am renaming the business to Studio Shay - it's just me now! That's not to say I'll be doing everything alone; I will continue to collaborate with other creatives on a project-by-project basis. I will be running the business independently as a digital product studio serving non-profits, community initiatives, and meaningful projects that align with my values. 
...
My overall strategy for Studio Shay is to develop a set of product templates which can then be white-labelled and further customized based on each client's specific needs. This will allow me to move faster and offer more fully-featured products to each client. It means that I can consolidate the knowledge and experience I gain from each individual project and pass it on to future projects in a very concrete way, by improving and developing the product templates. 

You can read more about the initial product packages on the [home page](/#packages). 

This is a departure from our previous strategy with Nomadic Labs - as a designer/developer team, our typical approach to new projects was to conduct an in-depth design process and create a bespoke product for every client. However as soon as Luisa told me she was leaving Nomadic Labs, I knew I would not be able to fill her shoes as a designer and strategist. She has a profound undestanding of stategy and design and an ability to translate that into creative concepts that elevate any project she's involved in. On the other hand, I'm more on the technical side and I love to experiment with different tools so that I can confidently choose the best approach to execute the projects I'm working on. Moving forward, my focus will be more solidly on web development and UI/UX design, which I consider to be my strongest areas of expertise.
